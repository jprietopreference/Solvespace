...
const Style::Default Style::Defaults[] {
    { hStyle { ACTIVE_GRP },   "ActiveGrp",    RGBf(1.0, 1.0, 1.0), 1.5, },
    { hStyle { CONSTRUCTION }, "Construction", RGBf(0.1, 0.7, 0.1), 1.5, },
    { hStyle { INACTIVE_GRP }, "InactiveGrp",  RGBf(0.5, 0.3, 0.0), 1.5, },
    { hStyle { DATUM },        "Datum",        RGBf(0.0, 0.8, 0.0), 1.5, },
    { hStyle { SOLID_EDGE },   "SolidEdge",    RGBf(0.8, 0.8, 0.8), 1.0, },
    { hStyle { CONSTRAINT },   "Constraint",   RGBf(1.0, 0.1, 1.0), 1.0, },
    { hStyle { SELECTED },     "Selected",     RGBf(1.0, 0.0, 0.0), 1.5, },
    { hStyle { HOVERED },      "Hovered",      RGBf(1.0, 1.0, 0.0), 1.5, },
    { hStyle { CONTOUR_FILL }, "ContourFill",  RGBf(0.0, 0.1, 0.1), 1.0, },
    { hStyle { NORMALS },      "Normals",      RGBf(0.0, 0.4, 0.4), 1.0, },
    { hStyle { ANALYZE },      "Analyze",      RGBf(0.0, 1.0, 1.0), 1.0, },
    { hStyle { DRAW_ERROR },   "DrawError",    RGBf(1.0, 0.0, 0.0), 8.0, },
    { hStyle { DIM_SOLID },    "DimSolid",     RGBf(0.1, 0.1, 0.1), 1.0, },
    { hStyle { 0 },            NULL,           RGBf(0.0, 0.0, 0.0), 0.0 }
};
